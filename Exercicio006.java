...
public class Exercicio006 {
	public static void main(String[] args) {
		 ...
		 * subtração, divisão e resto de dois números. Dados de teste: Insira o primeiro
		 * número: 125 Insira o segundo número: 24 Saída esperada : 125 + 24 = 149 125 -
		 * 24 = 101 125 x 24 = 3000 125 / 24 = 5 125 mod 24 = 5
		 */
